...
export default defineConfig({
  ...
  titleTemplate: ":title - Unfolding | NMS 教程 | Minecraft 我的世界 Bukkit 服务器插件开发指南",
  appearance: "dark",
  lastUpdated: true,
  rewrites: {
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/PVPINStudio/Unfolding",
      },
    ...
    editLink: {
      pattern:
        "https://github.com/PVPINStudio/Unfolding/edit/master/:path",
      text: "编辑本页内容",
    },
    lastUpdated: {
      text: "本页更新于",
